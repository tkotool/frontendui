...
declare global {
  ...
  const { storages: piniaPluginPersistedstate }: typeof import('../../node_modules/pinia-plugin-persistedstate/dist/nuxt/runtime/storages')
  const { updateAppConfig, useAppConfig }: typeof import('../../node_modules/nuxt/dist/app/config')
  const { useCountdown }: typeof import('../../app/composables/useCountdown')
  const { useFetch, useLazyFetch }: typeof import('../../node_modules/nuxt/dist/app/composables/fetch')
  const { useFlatpickr }: typeof import('../../app/composables/useFlatpickr')
  const { useHydration }: typeof import('../../node_modules/nuxt/dist/app/composables/hydrate')
  const { useLayout }: typeof import('../../app/stores/layout')
  ...
  const { usePageTitle }: typeof import('../../app/composables/usePageTitle')
  ...
  const { useSystemTheme }: typeof import('../../app/composables/useSystemTheme')
}
// for type re-export
declare global {
  // @ts-ignore

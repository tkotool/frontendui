    ...
    <div class="container">
      <div class="flex flex-col gap-y-16">
        <div class="text-center lg:w-3xl mx-auto">
          <h1 class="mb-4 leading-relaxed text-4xl font-semibold text-default-800">Tarifs</h1>
          <p class="text-lg text-default-500">Une tarification qui convient à tout le monde</p>
        </div>
        <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-5 mb-6">
          <div class="card">
            <div class="card-body">
              <h5 class="mb-2 flex items-center gap-1.5">
                <Icon icon="lucide:goal" class="text-success size-5"></Icon>
                <span class="text-lg font-semibold text-default-800">Lite</span>
              </h5>
              <p class="mb-4 text-default-500">Perfect plan for Lite</p>
              <h1 class="mb-4 text-4xl text-default-800 font-normal"><span class="text-default-400">$</span>9.99<small class="text-base text-default-500">/Monthly</small></h1>
              ...
              <ul class="mt-5 flex flex-col gap-3 text-sm">
                <li class="flex items-center gap-2.5">
                  <Icon icon="lucide:check-check" class="size-4 text-success"></Icon>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="mb-2 flex items-center gap-1.5">
                <Icon icon="lucide:graduation-cap" class="text-secondary size-5"></Icon>
              ...
              <h1 class="mb-4 text-4xl text-default-800 font-normal"><span class="text-default-400">$</span>29.99<small class="text-base text-default-500">/Monthly</small></h1>
              <button type="button" class="btn border w-full border-dashed border-primary bg-transparent text-primary hover:bg-primary/20">Purchase Now</button>
              <ul class="mt-5 flex flex-col gap-3 text-sm">
                <li class="flex items-center gap-2.5">
                  <Icon icon="lucide:check-check" class="size-4 text-success"></Icon>
          ...
          <div class="card relative overflow-hidden">
            <div class="card-body">
              <div class="size-16 absolute top-0 end-0">
                <div class="absolute bg-primary text-center w-42.5 text-white py-1 transform rotate-45 top-6 -end-12 font-semibold">25% Sale</div>
              </div>
              <h5 class="mb-2 flex items-center gap-1.5">
                <Icon icon="lucide:crown" class="text-primary size-5"></Icon>
              ...
              <h1 class="mb-4 text-4xl text-default-800 font-normal"><span class="text-default-400">$</span>39.99<small class="text-base text-default-500">/Monthly</small></h1>
              <button type="button" class="btn border w-full border-dashed border-primary bg-transparent text-primary hover:bg-primary/20">Purchase Now</button>
              <ul class="mt-5 flex flex-col gap-3 text-sm">
                <li class="flex items-center gap-2.5">
                  <Icon icon="lucide:check-check" class="size-4 text-success"></Icon>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="mb-2 flex items-center gap-1.5">
                <Icon icon="lucide:luggage" class="text-danger size-5"></Icon>
              ...
              <h1 class="mb-4 text-4xl text-default-800 font-normal"><span class="text-default-400">$</span>49.99<small class="text-base text-default-500">/Monthly</small></h1>
              <button type="button" class="btn border w-full border-dashed border-primary bg-transparent text-primary hover:bg-primary/20">Purchase Now</button>
              <ul class="mt-5 flex flex-col gap-3 text-sm">
                <li class="flex items-center gap-2.5">
                  <Icon icon="lucide:check-check" class="size-4 text-success"></Icon>

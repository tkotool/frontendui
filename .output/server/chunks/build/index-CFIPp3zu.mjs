...
import _sfc_main$2 from './CreateProduct-Bo91boMn.mjs';
import _sfc_main$3 from './ProductCard-DUt1pi4b.mjs';
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="grid lg:grid-cols-12 grid-cols-1 gap-6"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "grid lg:grid-cols-12 grid-cols-1 gap-6" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ecommerce/product-add/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-CFIPp3zu.mjs.map

      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`  <div class="text-sm text-default-800 leading-relaxed"${_scopeId}><p${_scopeId}> To enable the <strong${_scopeId}> medium-sized (compact) sidebar</strong>, add <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>data-sidenav-size=&quot;md&quot;</code> to the <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>&lt;html&gt;</code> tag. To apply this dynamically, use <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>setSideNavSize(&#39;md&#39;)</code> from the <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>useLayout</code>. </p></div></div></div>`);
          } else {
            return [
                ...
                createVNode("div", { class: "flex py-3 mb-5 rounded-md mx-4 mt-4" }, [
                  ...
                  createVNode("div", { class: "text-sm text-default-800 leading-relaxed" }, [
                    createVNode("p", null, [
                      ...
                      createVNode("strong", null, " medium-sized (compact) sidebar"),
                      createTextVNode(", add "),
                      createVNode("code", { class: "px-1 py-0.5 bg-default-100 rounded text-xs" }, 'data-sidenav-size="md"'),
                      ...
                      createVNode("code", { class: "px-1 py-0.5 bg-default-100 rounded text-xs" }, "setSideNavSize('md')"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/layout/compact-sidebar/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-C4mftGf4.mjs.map

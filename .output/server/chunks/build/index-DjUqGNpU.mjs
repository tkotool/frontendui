...
import _sfc_main$2 from './ApplyLeave-B7hKCgfX.mjs';
import LeaveInformation from './LeaveInformation-BPCDdqip.mjs';
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(LeaveInformation, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/hr-management/(leave-manage)/add-hr/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DjUqGNpU.mjs.map

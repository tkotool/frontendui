...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="my-auto"><div class="mt-8"><h4 class="mb-2 text-primary text-xl font-semibold">Set a New Password</h4><p class="text-base mb-8 text-default-500">Your new password should be distinct from any of your prior passwords</p></div><form action="/"><div class="text-start"><label for="Email" class="inline-block mb-2 text-sm text-default-800 font-medium">Password</label><input type="text" id="Email" class="form-input" placeholder="Password"></div><div class="text-start mt-4"><label for="Email" class="inline-block mb-2 text-sm text-default-800 font-medium">Confirm Password</label><input type="text" id="Email" class="form-input" placeholder="Confirm Password"></div><div class="flex items-center gap-2 mt-4"><div class="flex items-center h-5"><input id="checkbox-1" type="checkbox" class="form-checkbox"><label for="checkbox-1" class="sr-only">Checkbox</label></div><label class="text-default-900 text-sm font-medium" for="check">Remember me</label></div><div class="mt-8"><button type="button" class="btn bg-primary text-white w-full">Reset Password</button></div><div class="mt-4 text-center"><p class="text-base text-default-800">Hold on, I&#39;ve got my password... <a href="/modern-auth/login" class="text-primary underline"> Click here </a></p></div></form></div><div class="mt-5"><span class="font-base">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/(auth)/mordern-auth/create-pass/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-Bv8skBm7.mjs.map

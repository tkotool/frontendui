...
import _sfc_main$2 from './Profile-4FsJR718.mjs';
import _sfc_main$3 from './Table-0fA2GExy.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/hr-management/(attendance)/attendance/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-D0A2CNNr.mjs.map

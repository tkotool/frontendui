...
import _sfc_main$2 from './Stat-B1iAj2NY.mjs';
import _sfc_main$3 from './OrderTable-DQZBGulH.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ecommerce/order/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-BxNl9cYd.mjs.map

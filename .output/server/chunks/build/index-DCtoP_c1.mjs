...
import _sfc_main$2 from './Pricing-BO1zxclD.mjs';
import _sfc_main$3 from './HorizontalPricing-Dpopj-f2.mjs';
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h5 class="mt-2 mb-4 underline text-lg font-semibold text-default-700"${_scopeId}>Horizontal Pricing</h5>`);
            ...
            return [
              ...
              createVNode("h5", { class: "mt-2 mb-4 underline text-lg font-semibold text-default-700" }, "Horizontal Pricing"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/(pages)/pricing/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DCtoP_c1.mjs.map

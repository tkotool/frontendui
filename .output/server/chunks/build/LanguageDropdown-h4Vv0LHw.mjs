...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/LanguageDropdown.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const LanguageDropdown = Object.assign(_sfc_main, { __name: "LanguageDropdown" });

export { LanguageDropdown as L, logomodern as l, mordern as m };
//# sourceMappingURL=LanguageDropdown-h4Vv0LHw.mjs.map

      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`  <div class="text-sm text-default-800 leading-relaxed"${_scopeId}><p${_scopeId}> To switch to <strong${_scopeId}>Dark Mode</strong>, add <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>data-theme=&quot;dark&quot;</code> to the <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>&lt;html&gt;</code> tag. To apply this dynamically, use <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>setTheme(&#39;dark&#39;)</code> from the <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>useLayout</code>. </p></div></div></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "card" }, [
                createVNode("div", { class: "flex py-3 mb-5 rounded-md mx-4 mt-4" }, [
                  ...
                  createVNode("div", { class: "text-sm text-default-800 leading-relaxed" }, [
                    createVNode("p", null, [
                      createTextVNode(" To switch to "),
                      createVNode("strong", null, "Dark Mode"),
                      createTextVNode(", add "),
                      createVNode("code", { class: "px-1 py-0.5 bg-default-100 rounded text-xs" }, 'data-theme="dark"'),
                      ...
                      createVNode("code", { class: "px-1 py-0.5 bg-default-100 rounded text-xs" }, "setTheme('dark')"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/layout/dark-mode/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DBuzfD3e.mjs.map

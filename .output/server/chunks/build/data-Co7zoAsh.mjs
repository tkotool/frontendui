const setPositionOptions = [{ dir: "ltr-mode" }, { dir: "rtl-mode" }];
const sidenavColorOptions = [{ color: "light" }, { color: "dark" }];
...
export { setPositionOptions, sidenavColorOptions, sidenavSizes, themeOptions };
//# sourceMappingURL=data-Co7zoAsh.mjs.map

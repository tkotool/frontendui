...
import _sfc_main$2 from './Stat-CnOgCIAH.mjs';
import OrderInfo from './OrderInfo-B3SinEST.mjs';
import _sfc_main$3 from './OrderSummary-DtkOW125.mjs';
import _sfc_main$4 from './OrderStatus-BbBAzrHz.mjs';
import _sfc_main$5 from './Documents-DItJ60N2.mjs';
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 mb-5"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, null, null, _parent2, _scopeId));
            _push2(`</div><div class="grid lg:grid-cols-4 grid-cols-1 gap-5 mb-5"${_scopeId}><div class="lg:col-span-3 col-span-1"${_scopeId}>`);
            _push2(ssrRenderComponent(OrderInfo, null, null, _parent2, _scopeId));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ecommerce/order-detail/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-hl-ev2Nu.mjs.map

...
import _sfc_main$2 from './SideBar-CEydprmX.mjs';
import _sfc_main$3 from './MailBox-C-ZssqVg.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ class: "overflow-x-hidden" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="grid grid-cols-1"${_scopeId}><div class="col-span-1"${_scopeId}><div class="card"${_scopeId}><div class="flex"${_scopeId}>`);
...
//# sourceMappingURL=index-C43wQweQ.mjs.map

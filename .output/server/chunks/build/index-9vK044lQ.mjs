...
import _sfc_main$2 from './Filter-C8hjGJQa.mjs';
import _sfc_main$3 from './Product-BiMz2a31.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ecommerce/product-grid/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-9vK044lQ.mjs.map

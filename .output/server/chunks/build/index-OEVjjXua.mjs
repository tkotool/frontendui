...
import _sfc_main$2 from './SidebarProduct-LVgbL15X.mjs';
import _sfc_main$3 from './ProductDetails-oUhJOCTo.mjs';
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="grid lg:grid-cols-3 grid-cols-1 lg:gap-5"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "grid lg:grid-cols-3 grid-cols-1 lg:gap-5" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ecommerce/product-detail/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-OEVjjXua.mjs.map

      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`  <div class="text-sm text-default-800 leading-relaxed"${_scopeId}><p${_scopeId}> To enable the <strong${_scopeId}>full menu on hover after minimizing the sidebar</strong>, add <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>data-sidenav-size=&quot;hover&quot;</code> to the <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>&lt;html&gt;</code> tag. To apply this dynamically, use <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>setSideNavSize(&#39;hover&#39;)</code> from the <code class="px-1 py-0.5 bg-default-100 rounded text-xs"${_scopeId}>useLayout</code>. </p></div></div></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "card" }, [
                createVNode("div", { class: "flex py-3 mb-5 rounded-md mx-4 mt-4" }, [
                  ...
                  createVNode("div", { class: "text-sm text-default-800 leading-relaxed" }, [
                    createVNode("p", null, [
                      createTextVNode(" To enable the "),
                      createVNode("strong", null, "full menu on hover after minimizing the sidebar"),
                      createTextVNode(", add "),
                      createVNode("code", { class: "px-1 py-0.5 bg-default-100 rounded text-xs" }, 'data-sidenav-size="hover"'),
                      ...
                      createVNode("code", { class: "px-1 py-0.5 bg-default-100 rounded text-xs" }, "setSideNavSize('hover')"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/layout/hover-sidebar/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-BXjYIcJI.mjs.map

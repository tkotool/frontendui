...
import _sfc_main$2 from './Stat-CH3shRBt.mjs';
import _sfc_main$3 from './LeaveTable-C7PRQ38s.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/hr-management/(leave-manage)/leave-hr/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-C9h2AXKs.mjs.map

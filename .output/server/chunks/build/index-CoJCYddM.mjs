...
import _sfc_main$2 from './Calendar-0K6zshC7.mjs';
import _sfc_main$3 from './Event-InhBoC-7.mjs';
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="grid lg:grid-cols-4 gap-5"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "grid lg:grid-cols-4 gap-5" }, [
...
//# sourceMappingURL=index-CoJCYddM.mjs.map

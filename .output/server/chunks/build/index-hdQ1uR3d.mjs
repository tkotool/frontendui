...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="my-auto"><div class="mt-8 text-center"><div class="mb-4">`);
      _push(ssrRenderComponent(unref(Icon), {
        icon: "lucide:log-out",
        class: "size-6 text-purple-500 fill-purple-100 mx-auto"
      }, null, _parent));
      _push(`</div><h4 class="mb-2 text-primary text-xl font-semibold">You are Logged Out</h4><p class="mb-8 text-base text-default-500">Thank you for using tailwick admin template</p></div><a href="/"><button class="btn bg-primary text-white w-full">Sign In</button></a></div><div class="mt-5"><span class="font-base">`);
      _push(ssrRenderComponent(unref(Icon), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/(auth)/mordern-auth/logout/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-hdQ1uR3d.mjs.map

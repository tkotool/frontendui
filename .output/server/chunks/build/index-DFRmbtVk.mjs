...
import _sfc_main$2 from './ApplyLeave-DWQ-5W5_.mjs';
import LeaveInformation from './LeaveInformation-2zr-3Kxw.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/hr-management/(leave-manage)/add-employee/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DFRmbtVk.mjs.map

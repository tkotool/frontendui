...
import _sfc_main$2 from './Stat-zQiI2gNp.mjs';
import _sfc_main$3 from './Table-CS69Eo1v.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/hr-management/(attendance)/attendance-main/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-a4fUkzqX.mjs.map

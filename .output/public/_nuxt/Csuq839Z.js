const s=[{dir:"ltr-mode"},{dir:"rtl-mode"}],l=[{color:"light"},{color:"dark"}],a=[{theme:"light"},{theme:"dark"},{theme:"system"}],e=[{preview:` <span class="flex h-16 overflow-hidden border border-default-200 rounded-md">
                ...
                </span>`,label:"Defauit",size:"default"},{preview:`  <span class="flex h-16 overflow-hidden border border-default-200 rounded-md">
                    ...
                    <span class="flex flex-col flex-auto border-s border-default-200">
                        ...
                        <span class="flex flex-auto border-t border-default-200 bg-default-50"></span>
                ...
                </span> `,label:"Hover",size:"hover"},{preview:`  <span class="flex h-16 overflow-hidden border border-default-200 rounded-md">
                                ...
                                </span>`,label:"Hover-Active",size:"hover-active"},{preview:`   <span class="flex h-16 overflow-hidden border border-default-200 rounded-md">
                                    <span class="w-3 bg-default-100">
                                        <span class="w-1.5 h-1.5 mt-1 mx-auto rounded-sm bg-default-300"></span>
                                        <span class="flex flex-col items-center w-full mt-1.5 space-y-1">
                                            <span class="w-1.5 h-1.5 rounded-full bg-default-300"></span>
                                ...
                                </span>`,label:"Small",size:"sm"},{preview:`<span class="flex h-16 overflow-hidden border border-default-200 rounded-md">
                                ...
                                </span> `,label:"Compact",size:"md"},{preview:` <span class="flex h-16 overflow-hidden border border-default-200 rounded-md">
                                ...
                                </span> `,label:"Mobile",size:"offcanvas"},{preview:`  <span class="flex h-16 overflow-hidden border border-default-200 rounded-md">
                                    <span class="flex flex-col flex-auto">
                                        <span class="h-3 bg-default-100">
                                ...
                                </span>`,label:"Hidden",size:"hidden"}];export{s as setPositionOptions,l as sidenavColorOptions,e as sidenavSizes,a as themeOptions};
